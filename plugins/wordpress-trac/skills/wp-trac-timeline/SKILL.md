...
Run `${CLAUDE_PLUGIN_ROOT}/skills/wp-trac-timeline/scripts/timeline.php --help` for full documentation.
...
3. Run: `${CLAUDE_PLUGIN_ROOT}/skills/wp-trac-timeline/scripts/timeline.php [arguments]`
