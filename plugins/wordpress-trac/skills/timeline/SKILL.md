...
allowed-tools:
  - Bash(${CLAUDE_PLUGIN_ROOT}/skills/timeline/scripts/timeline.php:*)
...
Run `${CLAUDE_PLUGIN_ROOT}/skills/timeline/scripts/timeline.php --help` for full documentation.
...
3. Run: `${CLAUDE_PLUGIN_ROOT}/skills/timeline/scripts/timeline.php [arguments]`
