...
When ready, run:
- Basic info: `${CLAUDE_PLUGIN_ROOT}/skills/wp-trac-ticket/scripts/ticket.php <ticket-number>`
- With comments: `${CLAUDE_PLUGIN_ROOT}/skills/wp-trac-ticket/scripts/ticket.php --discussion <ticket-number>`
